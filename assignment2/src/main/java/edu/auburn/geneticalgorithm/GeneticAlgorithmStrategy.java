...
public interface GeneticAlgorithmStrategy<T, V extends Comparable<V>> {
  ...
  public List<FitnessRecord<T, V>> getFitnessRecords(List<T> population,
      FitnessEvaluator<T, V> fitnessEvaluator);

  public List<FitnessRecord<T, V>> selectIndividualsForReproduction(
